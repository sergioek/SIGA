<div>
    ...
    <input type="number" name="folio" id="" required class="form-control" placeholder="Ingrese el número de folio del reporte" min="1">
    @error('folio')
    <br>
        <small class="text-danger">*{{$message}}</small>
    <br>
