    ...
    <form method="POST" action="{{route('inscripcion.enrollment')}}">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <br>
            <select name="alumno_id" id="" class="form-control" required>
                @forelse ($alumnos as $alumno)
                     <option>{{$alumno->apellidos . " ".$alumno->nombres}}</option>
                     <input type="hidden" name="alumno_id" value="{{$alumno->id}}">
                     @empty
                     <option value="" class="text-danger">NO SE ENCONTRO UN ALUMNO</option>
                @endforelse
            </select>
            @error('alumno_id')
                  <small class="text-danger">*{{$message}}</small>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <br>
            <select name="tutor_id" id="" class="form-control" required>
                @forelse ($tutores as $tutor)
                     <option >{{$tutor->apellido . " ".$tutor->nombre}}</option>
                     <input type="hidden" name="tutor_id" value="{{$tutor->id}}">
                     @empty
                     <option>NO SE ENCONTRO UN TUTOR</option> 
                @endforelse
            </select>
            @error('tutor_id')
                  <small class="text-danger">*{{$message}}</small>
