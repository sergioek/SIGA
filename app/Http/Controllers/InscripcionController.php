...
class InscripcionController extends Controller
{
    ...
    public function update(Request $request, Inscripcion $inscripcion)
    {
        ...
        //redirige a la vista 
        return redirect()->route('inscripcion.index')->with('MsjExito','Se actualizó una inscripción.Vaya a asignar secciones a inscriptos para asignarle una nueva sección.');
    }
    ...
    public function enrollment(Request $request){
        ...
        return redirect()->route('inscripcion.index')->with('MsjExito','Se realizó una reinscripción.');
